...
function Player() {
    ...
    const uploadAudio = useCallback(async (event: { target: { files: any; }; }) => {
    ...
    return (
        <div style={{ width: '100%' }}>
            ...
            <div style={{ width: '90%', height: '392px', margin: '0 auto'}} id="waveContainer" />

            {!loading && soundController.current && (
                <div id="soundEditor" style={{marginTop: '50px'}}>
